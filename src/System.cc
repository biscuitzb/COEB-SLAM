...
namespace ORB_SLAM2
{
    ...
    cv::Mat System::TrackRGBD(const cv::Mat &im, const cv::Mat &depthmap, const double &timestamp, std::vector<std::vector<float>> &box)
    {
        if (mSensor != RGBD)
        {
        ...
        cv::Mat Tcw = mpTracker->GrabImageRGBD(im, depthmap, timestamp, box);
    ...
    void System::SaveTrajectoryTUM(const string &filename)
    {
        ...
        ofstream f;
        f.open("/home/jnu/桌面/trajectory/CameraTrajectory.txt");
        f << fixed;
    ...
    void System::SaveKeyFrameTrajectoryTUM(const string &filename)
    {
        ...
        ofstream f;
        f.open("/home/jnu/桌面/trajectory/KeyFrameTrajectory.txt");
        f << fixed;
